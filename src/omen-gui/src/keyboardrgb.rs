...
fn build_interactive_keyboard(
    ...
    let layout = vec![
        vec![("Esc", 1.0), ("F1", 1.0), ("F2", 1.0), ("F3", 1.0), ("F4", 1.0), ("F5", 1.0), ("F6", 1.0), ("F7", 1.0), ("F8", 1.0), ("F9", 1.0), ("F10", 1.0), ("F11", 1.0), ("F12", 1.0), ("Ins", 1.0), ("Del", 1.0), ("Omen", 1.0), ("PrtSc", 1.0), ("PgUp", 1.0), ("PgDn", 1.0)],
        ...
        vec![("Shift", 2.25), ("Z", 1.0), ("X", 1.0), ("C", 1.0), ("V", 1.0), ("B", 1.0), ("N", 1.0), ("M", 1.0), (",", 1.0), (".", 1.0), ("/", 1.0), ("Pause", 1.0), ("Shift_R", 1.75), ("Up", 0.8), ("1_num", 0.8), ("2_num", 0.8), ("3_num", 0.8), ("Ent", 0.8)],
        vec![("Ctrl", 1.25), ("Fn", 1.25), ("Win", 1.25), ("Alt", 1.25), ("Space", 5.0), ("Alt_R", 2.5), ("Ctrl_R", 2.5), ("Left", 0.8), ("Down", 0.8), ("Right", 0.8), ("0_num", 0.8), ("._num", 0.8)]
    ];
