...
fn build_interactive_keyboard(
    ...
    let layout = vec![
        vec![("Esc", 1.0), ("", 1.0), ("F1", 1.0), ("F2", 1.0), ("F3", 1.0), ("F4", 1.0), ("", 0.5), ("F5", 1.0), ("F6", 1.0), ("F7", 1.0), ("F8", 1.0), ("", 0.5), ("F9", 1.0), ("F10", 1.0), ("F11", 1.0), ("F12", 1.0), ("", 0.5), ("Ins", 1.0), ("Omen", 1.0), ("Del", 1.0), ("", 0.5), ("PrtSc", 1.0), ("PgUp", 1.0), ("PgDn", 1.0), ("Home", 1.0)],
        vec![("~", 1.0), ("1", 1.0), ("2", 1.0), ("3", 1.0), ("4", 1.0), ("5", 1.0), ("6", 1.0), ("7", 1.0), ("8", 1.0), ("9", 1.0), ("0", 1.0), ("-", 1.0), ("=", 1.0), ("Backspace", 2.0), ("", 0.5), ("", 3.0), ("", 0.5), ("Num", 1.0), ("/", 1.0), ("*", 1.0), ("-_num", 1.0)],
        vec![("Tab", 1.5), ("Q", 1.0), ("W", 1.0), ("E", 1.0), ("R", 1.0), ("T", 1.0), ("Y", 1.0), ("U", 1.0), ("I", 1.0), ("O", 1.0), ("P", 1.0), ("[", 1.0), ("]", 1.0), ("\\", 1.5), ("", 0.5), ("", 3.0), ("", 0.5), ("7_num", 1.0), ("8_num", 1.0), ("9_num", 1.0), ("+", 1.0)],
        vec![("Caps", 1.75), ("A", 1.0), ("S", 1.0), ("D", 1.0), ("F", 1.0), ("G", 1.0), ("H", 1.0), ("J", 1.0), ("K", 1.0), ("L", 1.0), (";", 1.0), ("'", 1.0), ("Enter", 2.25), ("", 0.5), ("", 3.0), ("", 0.5), ("4_num", 1.0), ("5_num", 1.0), ("6_num", 1.0), ("", 1.0)],
        vec![("Shift", 2.25), ("Z", 1.0), ("X", 1.0), ("C", 1.0), ("V", 1.0), ("B", 1.0), ("N", 1.0), ("M", 1.0), (",", 1.0), (".", 1.0), ("/", 1.0), ("Shift_R", 2.75), ("", 0.5), ("", 1.0), ("Up", 1.0), ("", 1.0), ("", 0.5), ("1_num", 1.0), ("2_num", 1.0), ("3_num", 1.0), ("Ent", 1.0)],
        vec![("Ctrl", 1.25), ("Win", 1.25), ("Alt", 1.25), ("Space", 6.25), ("Alt_R", 1.25), ("Fn", 1.25), ("Ctrl_R", 2.5), ("", 0.5), ("Left", 1.0), ("Down", 1.0), ("Right", 1.0), ("", 0.5), ("0_num", 2.0), ("._num", 1.0), ("", 1.0)]
    ];
